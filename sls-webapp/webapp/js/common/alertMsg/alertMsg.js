var alertMsg = {
    init:function(){
        ...
        if(this.$alertMsgBox.size()==0){
            this.$alertMsgBox = $('<div class="alertMsg" id="alertMsgBox"><div class="alertContent"><div class="alertError" id="alertTypeDiv"><div class="alertInner"><h1 id="alertMsgH1">错误</h1><div class="msg" id="msgDiv"></div></div><div class="toolBar"><ul id="btnUl"></ul></div></div></div><div class="alertFooter"><div class="alertFooter_r"><div class="alertFooter_c"></div></div></div><input type="text" name="_alertFocusCtr" style="width: 0; height: 0; display: none;"></div>');
            $("body").append(this.$alertMsgBox)
        }
        this.$alertMsgBox.css("top","-"+this.$alertMsgBox.css("height"))
    },
    show:function(typeName,msg,className){
        ...
        this.timer = setTimeout("alertMsg.hide()",2000)
    },
    hide:function(){
        this.$alertMsgBox.animate({"top": "-="+this.$alertMsgBox.height()+"px"}, "slow");
